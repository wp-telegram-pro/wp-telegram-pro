                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <fieldset>
                                        <label>
                                            <input type="radio" class="send-to-channel send-to-channel-yes" value="1" <?php checked(isset($send_to_channel) ? $send_to_channel : '', 1) ?> name="send_to_channel[<?php echo $options['channel_username'][$k] ?>]"> <?php _e('Yes', $this->plugin_key) ?>
                                        </label>
                                        <label>
                                            <input type="radio" class="send-to-channel send-to-channel-no" value="2" <?php checked(isset($send_to_channel) ? $send_to_channel : '', 2) ?> name="send_to_channel[<?php echo $options['channel_username'][$k] ?>]"> <?php _e('No', $this->plugin_key) ?>
                                        </label>
                                    </fieldset>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    <textarea name="channel_message_pattern[<?php echo $options['channel_username'][$k] ?>]" cols="50" class="message-pattern-wptp emoji" rows="4"><?php echo $channel_message_pattern ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <fieldset>
                                        <label>
                                            <input type="radio" value="1" <?php checked(isset($featured_image) ? $featured_image : '', 1) ?> name="channel_with_featured_image[<?php echo $options['channel_username'][$k] ?>]"> <?php _e('Yes', $this->plugin_key) ?>
                                        </label>
                                        <label>
                                            <input type="radio" value="2" <?php checked(isset($featured_image) ? $featured_image : '', 2) ?> name="channel_with_featured_image[<?php echo $options['channel_username'][$k] ?>]"> <?php _e('No', $this->plugin_key) ?>
                                        </label>
                                    </fieldset>
                                </td>
                            </tr>
        ...
        <div id="<?php echo $this->tabID ?>-content" class="wptp-tab-content hidden">
            <table>
                <tr>
                    ...
                    <td>
                        <label><input type="checkbox" id="send_to_channels" class="send_to_channels" value="1" <?php checked($this->get_option('send_to_channels'), 1) ?> name="send_to_channels"> <?php _e('Active', $this->plugin_key) ?>
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="number" name="channels_cron_interval" id="channels_cron_interval" value="<?php echo $this->get_option('channels_cron_interval', 1) ?>" placeholder="1" min="1" max="60" class="small excerpt_length ltr"> <?php _e('Minutes', $this->plugin_key) ?>,
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" name="channels_delay_send" id="channels_delay_send" value="<?php echo $this->get_option('channels_delay_send', 5) ?>" placeholder="0" min="0" class="small excerpt_length ltr"> <?php _e('Minutes', $this->plugin_key) ?>,
            ...
            <div class="channel-list-wptp accordion-wptp">
                <?php
                        ...
                        ?>
                <button type="button" class="add-channel" <?php echo $c >= $this->max_channel ? 'disabled' : '' ?>><span class="dashicons dashicons-plus"></span> <?php _e('Add Channel', $this->plugin_key) ?>
                </button>
            </div>
        </div>
    <?php
        ...
        <div class="item" data-index="<?php echo $item['index'] ?>">
            <button class="toggle" type="button"><?php echo isset($item['channel_username']) && !empty($item['channel_username']) ? '@' . $item['channel_username'] : __('New Channel', $this->plugin_key); ?></button>
            <div class="panel">
                <table>
                    <tr>
                        <td>
                        ...
                        <td>
                            @<input type="text" name="channel_username[<?php echo $item['index'] ?>]" value="<?php echo isset($item['channel_username']) ? $item['channel_username'] : '' ?>" class="channel-username-wptp ltr">
                    ...
                    <tr>
                        ...
                        <td>
                            <label><input type="checkbox" class="send_to_channel" value="1" <?php checked(isset($item['send_to_channel']) ? $item['send_to_channel'] : '', 1) ?> name="send_to_channel[<?php echo $item['index'] ?>]"> <?php _e('Active', $this->plugin_key) ?>
                            </label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php $this->select_tags() ?>
                            <br>
                            <textarea name="channel_message_pattern[<?php echo $item['index'] ?>]" cols="50" class="message-pattern-wptp emoji" rows="4"><?php echo isset($item['message_pattern']) ? stripslashes($item['message_pattern']) : '' ?></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <label><input type="checkbox" class="with_featured_image" value="1" <?php checked(isset($item['with_featured_image']) ? $item['with_featured_image'] : '', 1) ?> name="channel_with_featured_image[<?php echo $item['index'] ?>]"> <?php _e('Yes', $this->plugin_key) ?>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <span class="description"><?php _e('Telegram supports basic markdown and some HTML tags (bold, italic, inline links). By checking one of the following options, your messages will be compatible with Telegram format.', $this->plugin_key) ?>
                                (<a href="https://core.telegram.org/bots/api#formatting-options" target="_blank"><?php _e('Telegram Bot API', $this->plugin_key) ?></a>)</span>
                            <br>
                            <select name="channel_formatting_messages[<?php echo $item['index'] ?>]" class="formatting_messages">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" name="channel_excerpt_length[<?php echo $item['index'] ?>]" value="<?php echo isset($item['excerpt_length']) ? $item['excerpt_length'] : '' ?>" placeholder="<?php echo $this->excerpt_length ?>" class="excerpt_length ltr"> <?php _e('Word', $this->plugin_key) ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="channel_inline_button_title[<?php echo $item['index'] ?>]" value="<?php echo isset($item['inline_button_title']) ? $item['inline_button_title'] : '' ?>" class="inline_button_title regular-text">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <label><input type="checkbox" class="disable_web_page_preview" value="1" <?php checked(isset($item['disable_web_page_preview']) ? $item['disable_web_page_preview'] : '', 1) ?> name="channel_disable_web_page_preview[<?php echo $item['index'] ?>]"> <?php _e('Disable', $this->plugin_key) ?>
                            </label>
                        </td>
                    </tr>
                    <!--<tr>
